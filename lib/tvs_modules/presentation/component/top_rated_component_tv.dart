...
class TopRatedComponentTv extends StatelessWidget {
  const TopRatedComponentTv({Key? key}) : super(key: key);
...
class TopRatedDetailsScreenTv extends StatelessWidget {
  const TopRatedDetailsScreenTv({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => sl<TvBloc>()..add(GetTopRatedTvEvent()),

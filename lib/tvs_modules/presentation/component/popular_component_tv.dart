...
class PopularComponentTv extends StatelessWidget {
  PopularComponentTv({Key? key, required this.axis}) : super(key: key);
  Axis axis;
...
class PopularDetailsScreenTv extends StatelessWidget {
  const PopularDetailsScreenTv({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => sl<TvBloc>()..add(GetPopularTvEvent()),

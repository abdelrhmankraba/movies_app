...
import 'package:movies_app/tvs_modules/presentation/component/on_the_air_component.dart';
...
import 'package:movies_app/tvs_modules/presentation/screens/popular_movies_screen.dart';
import 'package:movies_app/tvs_modules/presentation/screens/top_rated_movies_screen.dart';
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        navigateTo(context, const PopularTvScreen());
                      },
                      child: Padding(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        navigateTo(context, const TopRatedTvScreen());
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(

                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: Constants.imageUrl(state.movieDetail!.backdropPath),
              ...
              (context, index) {
                ...
                return FadeInUp(
                  ...
                  child: ClipRRect(
                    ...
                    child: InkWell(
                      onTap: () {
                        navigateTo(context, MovieDetailScreen(id: recommendation.id));
                      },
                      child: CachedNetworkImage(
                        imageUrl:
                        Constants.imageUrl(recommendation.backdropPath!),
          ...
          return SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: FadeInUp(
                ...
                child:Center(
                  child: Text(
                    'Not Found Movies Like This Movie',
                    style: TextStyle(

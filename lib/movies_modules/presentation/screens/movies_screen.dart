...
import 'package:movies_app/movies_modules/presentation/component/now_playing_component.dart';
...
import 'package:movies_app/movies_modules/presentation/screens/popular_movies_screen.dart';
import 'package:movies_app/movies_modules/presentation/screens/top_rated_movies_screen.dart';
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        navigateTo(context, const PopularMoviesScreen());
                      },
                      child: Padding(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        navigateTo(context, const TopRatedMoviesScreen());
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
